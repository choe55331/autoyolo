...
학습이 끝났다면 게임이나 앱 화면에서 실시간으로 Rune을 감지할 수 있어요!
...
# 또는 명령어로
python detect_screen.py --monitor 1  # 첫 번째 모니터
```

자세한 사용법: **[화면_감지_사용법.md](화면_감지_사용법.md)**
